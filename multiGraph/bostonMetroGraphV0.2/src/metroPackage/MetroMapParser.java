...
import metroPackage.BadFileException;
            ...
            throws IOException, BadFileException
    {
        ...
        while(line != null)
        {
            ...
            while(st.hasMoreTokens())
            {
                ...
                metro.setEdge(lineName, Integer.parseInt(outboundID), Integer.parseInt(stationID));
                metro.setEdge(lineName, Integer.parseInt(stationID), Integer.parseInt(inboundID));
            }

            metro.setNode(Integer.parseInt(stationID), stationName);
            line = fileInput.readLine();
        }
