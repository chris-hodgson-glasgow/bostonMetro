...
//	String filename = args[0];
	...
	System.out.printf("java ex3.MetroMapParser bostonmetro.txt\n");
    }
	...
	throws IOException, BadFileException
    {
    	...
    	String[][] stationArray = new String[124][5];
	...
	while(line != null)
	{
	    ...
	    stationArray[counter][0] = stationID;
	    stationArray[counter][1] = stationName;
	    stationArray[counter][2] = lineName;
	    stationArray[counter][3] = outboundID;
	    stationArray[counter][3] = inboundID;
...
//	for(int i = 0; i < 124; i++ )
//	{
//		System.out.println(stationArray[i][0]);
//		System.out.println(stationArray[i][1]);
//		System.out.println(stationArray[i][2]);
//		System.out.println(stationArray[i][3]);
//		
//	}
