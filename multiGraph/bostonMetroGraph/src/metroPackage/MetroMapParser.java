...
class MetroMapParser
{
    ...
    MetroMapParser(String filename) throws IOException
    {
    ...
    void  generateGraphFromFile(Metro metro)
            throws IOException, BadFileException
    {
        ...
        while(line != null)
        {
            ...
            while(st.hasMoreTokens())
            {
                ...
                metro.setTrack(lineName,Integer.parseInt(outboundID),Integer.parseInt(stationID));
                metro.setTrack(lineName,Integer.parseInt(stationID),Integer.parseInt(inboundID));
            }

            metro.setStation(Integer.parseInt(stationID),stationName);
            line = fileInput.readLine();
